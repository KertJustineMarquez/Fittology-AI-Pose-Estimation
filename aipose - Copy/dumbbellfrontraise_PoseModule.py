...
def findAngle(self, img, p1, p2, p3, draw=True):
    if len(self.lmList) != 0:
        ...
        # Define a threshold angle for detecting the dumbbell front raise
        # Adjust this threshold based on your specific requirements and experimentation
        threshold_angle = 60  # Example threshold angle

        # Check if the angle exceeds the threshold
        if angle > threshold_angle and draw:
            # Draw the landmarks and angle if required
            ...
            cv2.putText(img, "Dumbbell Front Raise Detected", (50, 50), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
